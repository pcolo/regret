...
class NeuralNetwork(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, inp_neu=1, hid_neu=2, out_neu=1, learn_rate=0.1, nomentum=0.5, weight_dec=0.0001, epochs=100,
                 split_prop=0.25):
    ...
    def data(self, X, y=None):
        ...
        for i in range(0, len(X)):
                DS.addSample((X[i]), y[i]) #ATTENTION pas optimisé pour toutes les tailles
        return DS
