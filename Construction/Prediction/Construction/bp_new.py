...
bdata = pd.read_csv(r'C:\Users\philippe.colo\Projects\regret\data\MT_161.csv', delimiter=';', na_values=0, nrows=96*365*3,
...
print trainX, max(trainY)

bdata = pd.read_csv(r'C:\Users\philippe.colo\Projects\regret\data\MT_161.csv', delimiter=';', skiprows=range(1, 96*365*3), na_values=0, nrows=96*365,
                     index_col=0, parse_dates=True, infer_datetime_format=True)
